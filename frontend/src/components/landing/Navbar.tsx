...
export default function Navbar() {
  ...
  return (
    <header
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-brand-dark/95 backdrop-blur-md ${
        scrolled ? 'shadow-lg border-b border-border-dark' : ''
      }`}
    >
        ...
        <div className="flex items-center justify-between h-32 lg:h-36">
          ...
          >
            <img
              ...
              alt="ScadaTech logo"
              className="h-20 w-auto object-contain group-hover:opacity-90 transition-opacity duration-200"
            />
          </a>
